...
> - Điền email liên hệ thật ở mục 10 (hiện: `lamubboy@gmail.com`)
...
| 🗑️ **Yêu cầu xóa dữ liệu** | Email: `lamubboy@gmail.com` (tiêu đề: "Xóa dữ liệu") | Trong vòng **7 ngày** |
| 📥 **Yêu cầu xuất dữ liệu** | Email: `lamubboy@gmail.com` (tiêu đề: "Xuất dữ liệu") | Trong vòng **7 ngày** |
| 👁️ **Xem dữ liệu đang lưu** | Email: `lamubboy@gmail.com` (tiêu đề: "Xem dữ liệu") | Trong vòng **7 ngày** |
